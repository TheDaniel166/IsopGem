...
from ..services import (
    AnnulusShape,
    AnnulusShape,
    CircleShapeService,  # Renamed
    CrescentShape,
    EllipseShapeService,  # Renamed
    RoseCurveShape,
    SquareShapeService,  # Renamed
    RectangleShapeService,  # Renamed
    ParallelogramShape,
    RhombusShape,
    TrapezoidShape,
    ...
    # VaultOfHestiaSolidCalculator,  # Removed - use VaultOfHestiaSolver from canon module
    SphereSolidService,
        ...
        shapes=[
            {
                ...
                'factory': None,  # Superseded by Canon
            ...
            },
            {
                ...
                'default_canonical': {'semi_major_axis': 2.0, 'semi_minor_axis': 1.0},
            },
            {
                'name': 'Annulus',
        ...
        shapes=[
            {
                ...
                'default_canonical': {'num_sides': 5, 'side_length': 1.0},
            ...
            },
            {
                ...
                'solver': RegularPolygonSolver,
                'realizer': RegularPolygonRealizer,
                'default_canonical': {'num_sides': 6, 'side_length': 1.0},
            ...
            },
            {
                ...
                'solver': RegularPolygonSolver,
                'realizer': RegularPolygonRealizer,
                'default_canonical': {'num_sides': 7, 'side_length': 1.0},
            ...
            },
            {
                ...
                'solver': RegularPolygonSolver,
                'realizer': RegularPolygonRealizer,
                'default_canonical': {'num_sides': 8, 'side_length': 1.0},
            ...
            },
            {
                ...
                'solver': RegularPolygonSolver,
                'realizer': RegularPolygonRealizer,
                'default_canonical': {'num_sides': 9, 'side_length': 1.0},
            ...
            },
            {
                ...
                'solver': RegularPolygonSolver,
                'realizer': RegularPolygonRealizer,
                'default_canonical': {'num_sides': 10, 'side_length': 1.0},
            ...
            },
            {
                ...
                'solver': RegularPolygonSolver,
                'realizer': RegularPolygonRealizer,
                'default_canonical': {'num_sides': 11, 'side_length': 1.0},
            ...
            },
            {
                ...
                'solver': RegularPolygonSolver,
                'realizer': RegularPolygonRealizer,
                'default_canonical': {'num_sides': 12, 'side_length': 1.0},
    ...
    _category(
        ...
        shapes=[
            ...
            },
            {
                ...
                'summary': 'Configurable prism supporting any base polygon (n ≥ 3) with dynamic extrusion.',
                'type': 'solid_viewer',
    ...
    _category(
        ...
        shapes=[
            ...
            },
            {
                ...
                'summary': 'Configurable antiprism supporting any base polygon (n ≥ 3) with twist solving.',
                'type': 'solid_viewer',
...
SOLID_VIEWER_CONFIG: Dict[str, dict] = {
    ...
    'vault_of_hestia_3d': {
        ...
        'calculator': None,  # Calculator removed - use unified viewer with VaultOfHestiaSolver
