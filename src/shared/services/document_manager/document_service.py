...
from shared.services.document_manager.utils.image_utils import (
    extract_images_from_html, 
    restore_images_in_html,
    has_embedded_images
)
from shared.models.document_manager.document import Document, DocumentImage
...
class DocumentService:
    ...
    def get_document_with_images(self, doc_id: int, restore_images: bool = False) -> Optional[Tuple[Document, str]]:
        ...
        from shared.services.document_manager.utils.image_utils import has_docimg_references
