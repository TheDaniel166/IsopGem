...
def get_seed_values():
    ...
    print(f"Writing seeds to {output_path}...")
    
    with open(output_path, 'w', newline='') as csvfile:
        fieldnames = ['Wall', 'Group', 'Seed_Row', 'Seed_Col', 'Value']
        ...
        for wall, grid in lattices.items():
            ...
            for gid in sorted(groups.keys()):
                ...
                writer.writerow({'Wall': wall, 'Group': gid, 'Seed_Row': r, 'Seed_Col': c, 'Value': val})
