...
- Coordinate detector and simulator widgets and manage session state
- Route audio input to detection and visualization services
- Manage presets, export, and user-configurable parameters

<!-- VISUAL: autogenerated from src/pillars/cymatics/ui/cymatics_hub.py -->
**ASCII UI mockup:**
...
```mermaid
sequenceDiagram
    User->>CymaticsHub: click Start
    CymaticsHub->>AudioService: start_stream()
    AudioService-->>DetectorService: data_chunk
    DetectorService-->>CymaticsHub: detection_event
```
