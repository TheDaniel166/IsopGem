...
### **ternary_service.py** (`src/pillars/tq/services/ternary_service.py`)
...
### **ditrunal_service.py** (`src/pillars/tq/services/ditrunal_service.py`)
...
### **kamea_grid_service.py** (`src/pillars/tq/services/kamea_grid_service.py`)
...
### **amun_audio_service.py** (`src/pillars/tq/services/amun_audio_service.py`)
...
### **quadset_engine.py** (`src/pillars/tq/services/quadset_engine.py`)
...
### **ternary_transition_service.py** (`src/pillars/tq/services/ternary_transition_service.py`)
...
### **pattern_analyzer.py** (`src/pillars/tq/services/pattern_analyzer.py`)
...
*   **Key Logic**:
    ...
    *   **Helper**: `number_properties.py` (`src/pillars/tq/services/number_properties.py`)

### **kamea_symphony_service.py** (`src/pillars/tq/services/kamea_symphony_service.py`)
*   **Architectural Role**: Service (The Conductor)
*   **The Purpose**: Orchestrates large-scale audio synthesis for entire Kamea slices.

### **baphomet_color_service.py** (`src/pillars/tq/services/baphomet_color_service.py`)
...
### **geometric_transition_service.py** (`src/pillars/tq/services/geometric_transition_service.py`)
*   **Architectural Role**: Service (The Animator)
...
### **conrune_pair_finder_service.py** (`src/pillars/tq/services/conrune_pair_finder_service.py`)
...
### **platonic_transition_service.py** (`src/pillars/tq/services/platonic_transition_service.py`)
...
### **quadset_analysis_window.py** (`src/pillars/tq/ui/quadset_analysis_window.py`)
...
### **kamea_fractal_view.py** (`src/pillars/tq/ui/kamea_fractal_view.py`)
...
### **kamea_grid_view.py** (`src/pillars/tq/ui/kamea_grid_view.py`)
*   **Architectural Role**: View (The 2D Engine)
*   **The Purpose**: Interactive 2D Slice view of the Kamea.

### **nuclear_mutation_panel.py** (`src/pillars/tq/ui/nuclear_mutation_panel.py`)
*   **Architectural Role**: View (The Inspector)
*   **The Purpose**: Displays the deep lineage (Core, Body, Skin) of the selected Ditrune.

### **ternary_converter_window.py** (`src/pillars/tq/ui/ternary_converter_window.py`)
*   **Architectural Role**: View (The Calculator)
*   **The Purpose**: Simple utility for Decimal <-> Ternary conversion.
*   **Key Logic**: Also displays `fractal_network_dialog.py` (`src/pillars/tq/ui/fractal_network_dialog.py`).

### **transitions_window.py** (`src/pillars/tq/ui/transitions_window.py`)
*   **Architectural Role**: View (The Animator)
*   **The Purpose**: visualizing the `TernaryTransitionService` logic.

### **amun_visualizer.py** (`src/pillars/tq/ui/amun_visualizer.py`)
...
### **ternary_sound_widget.py** (`src/pillars/tq/ui/ternary_sound_widget.py`)
...
### **kamea_cell.py** (`src/pillars/tq/models/kamea_cell.py`)
...
### **amun_sound.py** (`src/pillars/tq/models/amun_sound.py`)
*   **Architectural Role**: Domain Model
