...
- [src/pillars/correspondences/ui/components/formula_bar.py](file://src/pillars/correspondences/ui/components/formula_bar.py)
</cite>
...
- **formula_bar**: `src/pillars/correspondences/ui/components/formula_bar.py`
...
Handles FormulaBar operations

## UI Components

### Main Window/Widget

**Implementation**: `src/pillars/correspondences/ui/components/formula_bar.py`
...
- **`text_changed`**: Emitted with arguments: `str`
- **`return_pressed`**: Emitted with arguments: ``
- **`focus_received`**: Emitted with arguments: ``
- **`fx_clicked`**: Emitted with arguments: ``
