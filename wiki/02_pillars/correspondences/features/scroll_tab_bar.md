...
- [src/pillars/correspondences/ui/scroll_tab_bar.py](file://src/pillars/correspondences/ui/scroll_tab_bar.py)
</cite>
...
**User Capabilities**:
- Interact with Menu, HBoxLayout, Action, TabBar, ToolButton
- Perform actions
- Process data:
- Primary action 1
- Primary action 2
...
- **scroll_tab_bar**: `src/pillars/correspondences/ui/scroll_tab_bar.py`
...
**Implementation**: `src/pillars/correspondences/ui/scroll_tab_bar.py`
...
- **`tab_added`**: Emitted with arguments: ``
- **`tab_changed`**: Emitted with arguments: `int`
- **`tab_renamed`**: Emitted with arguments: `int, str`
- **`show_all_tabs`**: Emitted with arguments: ``
