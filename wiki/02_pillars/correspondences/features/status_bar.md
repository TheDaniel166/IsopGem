...
- [src/pillars/correspondences/ui/components/status_bar.py](file://src/pillars/correspondences/ui/components/status_bar.py)
</cite>
...
- **status_bar**: `src/pillars/correspondences/ui/components/status_bar.py`
...
Handles StatusBar operations

## UI Components

### Main Window/Widget

**Implementation**: `src/pillars/correspondences/ui/components/status_bar.py`
...
- **`zoom_changed`**: Emitted with arguments: `int`
